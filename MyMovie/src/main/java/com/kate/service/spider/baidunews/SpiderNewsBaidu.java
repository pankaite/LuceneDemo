package com.kate.service.spider.baidunews;
...
//			System.out.println(newsSummary);
	...
	public static void main(String[] args) {
		SpiderNewsBaidu spider = new SpiderNewsBaidu();
		String content = new SpiderNewsBaidu().getContent("http://cq.people.com.cn/GB/365409/c29461628.html");
//		String test1 = "<h3 class=\"c-title\"><a href=\"http://cq.people.com.cn/GB/365644/367006/?Num=29461628\" title=\"历史第4！《你的名字。》日本票房超《哈利·波特与魔法石》\" target=\"_blank\">手机版新闻</a></h3>";
//		String test2 = "<p class=\"c-author\">来源：光明网&nbsp;&nbsp;2016-12-14 09:26:37</p>";
//		String test3 = "8小时前";
//		String test4 = "</p>历史第4！《你的名字。》日本票房超《哈利·波特与魔法石》<span class=\"c-info\">";
//		String result = spider.getNewsUrl(test1); //http://cq.people.com.cn/GB/365644/367006/?Num=29461628
//		String result = spider.getNewsTitle(test1); //手机版新闻
//		String result = spider.getMediaAndTime(test2); //[来源：光明网, 2016-12-14 09:26:37]
//		String result = spider.getReleaseTime(test3); //2017-10-21 09:52
//		String result = spider.getNewsSummary(test4); //历史第4！《你的名字。》日本票房超《哈利·波特与魔法石》
